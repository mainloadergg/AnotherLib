...
message.Text = "Hello\nPlease Join Our New Server, More Updates / Supports\nDiscord: https://discord.gg/2uUUMKSQyq (Copied)"
setclipboard("https://discord.gg/2uUUMKSQyq")]]
...
local Themes = {
	...
	GenesisX = {
		...
		AcrylicMain = Color3.fromRGB(18, 12, 28),
		AcrylicBorder = Color3.fromRGB(45, 30, 70),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(35, 20, 55), Color3.fromRGB(12, 8, 20)),
		AcrylicNoise = 0.8,

		TitleBarLine = Color3.fromRGB(80, 60, 110),
		Tab = Color3.fromRGB(100, 30, 160),

		Element = Color3.fromRGB(100, 30, 160),
		ElementBorder = Color3.fromRGB(50, 40, 70),
		InElementBorder = Color3.fromRGB(80, 60, 110),
		ElementTransparency = 0.75,

		ToggleSlider = Color3.fromRGB(140, 50, 220),
		ToggleToggled = Color3.fromRGB(255, 255, 255),

		SliderRail = Color3.fromRGB(140, 130, 160),

		DropdownFrame = Color3.fromRGB(25, 18, 40),
		DropdownHolder = Color3.fromRGB(40, 28, 60),
		DropdownBorder = Color3.fromRGB(120, 40, 200),
		DropdownOption = Color3.fromRGB(160, 60, 230),

		Keybind = Color3.fromRGB(110, 35, 180),

		Input = Color3.fromRGB(180, 170, 200),
		InputFocused = Color3.fromRGB(0, 0, 0),
		InputIndicator = Color3.fromRGB(180, 80, 255),

		Dialog = Color3.fromRGB(25, 18, 40),
		DialogHolder = Color3.fromRGB(40, 28, 55),
		DialogHolderLine = Color3.fromRGB(120, 40, 200),
		DialogButton = Color3.fromRGB(25, 18, 40),
		DialogButtonBorder = Color3.fromRGB(160, 60, 255),
		DialogBorder = Color3.fromRGB(70, 50, 100),
		DialogInput = Color3.fromRGB(35, 25, 50),
		DialogInputLine = Color3.fromRGB(160, 60, 230),

		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(180, 170, 200),
		Hover = Color3.fromRGB(160, 60, 230),
		HoverChange = 0.08,
	}    
}
...
do 
	...
	local GUI1 = game:GetService("CoreGui"):FindFirstChild("GenesisXYZ_ScreenGui")
	if GUI1 then 
		GUI1:Destroy()
	end
end
...
local SaveManager = {} do
	SaveManager.Folder = "GenesisXYZSettings"
	SaveManager.Ignore = {}
	SaveManager.Parser = {
		Toggle = {
...
local InterfaceManager = {} do
	InterfaceManager.Folder = "GenesisXYZ_Config"
...
function Library:CreateWindow(Config)
	...
	Library.Theme = Config.Theme or "GenesisX"
...
-- ========================
-- Helper Functions (Funcs) - included by default
-- ========================
...
if getgenv then
	getgenv().GenesisXYZ = Library
	getgenv().Fluent = Library -- backward compatibility
else
	GenesisXYZ = Library
	Fluent = Library
end
